...
![](/images/Vbird/12-2.1.png)

![](/images/Vbird/12-2.2.png)
...
![](/images/Vbird/10-2.1.png)

`var=${var1:-content}`如果var1不存在或者为空字符串，则var=content

![](/images/Vbird/10-2.2.png)
...
- 常见指令
  ...
  - `pwd`显示目前目录（print working dictionary）
    ...
    ![](/images/Vbird/6-1.1.png)

  - `mkdir`创建一个新目录

    ![](/images/Vbird/6-1.2.png)

    - -m 设置创建目录权限，默认新建目录的权限可以看到是755，这个跟umask有关

    ![](/images/Vbird/6-1.4.png)

    - -p 将输入的不存在的父级目录同时创建出来

    ![](/images/Vbird/6-1.3.png)

  - `rmdir`删除一个空目录

    - -p 删除输入的所有空目录

    ![](/images/Vbird/6-1.5.png)

    - 成功删除test1/test2/test3

    ![](/images/Vbird/6-1.6.png)
...
![](/images/Vbird/6-4.2.png)

![](/images/Vbird/6-4.3.png)
